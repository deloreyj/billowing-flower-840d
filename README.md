...
```
npm create cloudflare@latest -- --template=cloudflare/templates/billowing-flower-840d
```

A live public deployment of this template is available at [https://billowing-flower-840d.templates.workers.dev](https://billowing-flower-840d.templates.workers.dev)
